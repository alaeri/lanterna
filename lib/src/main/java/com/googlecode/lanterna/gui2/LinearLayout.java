...
public class LinearLayout implements LayoutManager {
    ...
    @Override
    public TerminalSize getPreferredSize(List<? extends Component> components) {
    ...
    private TerminalSize getPreferredSizeVertically(List<? extends Component> components) {
        int maxWidth = 0;
        int height = 0;
    ...
    private TerminalSize getPreferredSizeHorizontally(List<? extends Component> components) {
        int maxHeight = 0;
        int width = 0;
        for(Component component: components) {
            TerminalSize preferredSize = component.getPreferredSize();
    ...
    @Override
    public void doLayout(TerminalSize area, List<? extends Component> components) {
        // Filter out invisible components
        components = components.stream().filter(Component::isVisible).collect(Collectors.toList());
    ...
    @Deprecated
    private void doVerticalLayout(TerminalSize area, List<? extends Component> components) {
    ...
    private void doFlexibleVerticalLayout(TerminalSize area, List<? extends Component> components) {
    ...
    @Deprecated
    private void doHorizontalLayout(TerminalSize area, List<? extends Component> components) {
    ...
    private void doFlexibleHorizontalLayout(TerminalSize area, List<? extends Component> components) {
        int availableVerticalSpace = area.getRows();
        int availableHorizontalSpace = area.getColumns();
        List<Component> copyOfComponenets = new ArrayList<>(components);
        final Map<Component, TerminalSize> fittingMap = new IdentityHashMap<>();
