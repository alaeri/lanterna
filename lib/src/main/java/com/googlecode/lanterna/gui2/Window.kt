...
interface Window : BasePane {
     ...
     */
//    JvmDefault
//    fun getBounds(): TerminalRectangle? {
...
//    }
     ...
     */
    override fun setFocusedInteractable(interactable: Interactable?)
     ...
     */
    @Deprecated(
        """This is deprecated in favor of calling either of: {@code toGlobalFromContentRelative()} or {@code toGlobalFromDecoratedRelative()}.
      """
    )
     ...
     */
    @Deprecated(
        """This is deprecated in favor of calling either of: {@code fromGlobalToContentRelative()} or {@code fromGlobalToDecoratedRelative()}
      """
    )
     ...
     */
    override fun getMenuBar(): MenuBar
}