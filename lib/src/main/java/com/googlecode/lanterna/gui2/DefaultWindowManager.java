...
public class DefaultWindowManager implements WindowManager {
    ...
    @Override
    public void onAdded(WindowBasedTextGUI textGUI, Window window, List<? extends Window> allWindows) {
    ...
    @Override
    public void onRemoved(WindowBasedTextGUI textGUI, Window window, List<? extends Window> allWindows) {
        //NOP
    }

    @Override
    public void prepareWindows(WindowBasedTextGUI textGUI, List<? extends Window> allWindows, TerminalSize screenSize) {
