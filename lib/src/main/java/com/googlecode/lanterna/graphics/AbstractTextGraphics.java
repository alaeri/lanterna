...
public abstract class AbstractTextGraphics implements TextGraphics {
    ...
    @Override
    public TextGraphics putString(int column, int row, String string, Collection<? extends SGR> extraModifiers) {
        java.util.Set<SGR> newModifiers = java.util.Set.copyOf(extraModifiers);
