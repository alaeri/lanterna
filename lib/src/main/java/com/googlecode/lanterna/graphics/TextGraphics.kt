 ...
 * @author Martin
 */
interface TextGraphics : StyleSet<TextGraphics> {
    /**
     ...
     *
     *
     * This method has an additional functionality to the regular [TextGraphics.putString];
     ...
     *
     * When the call is complete, the [TextGraphics] object will return to the color/style state it was in at the
     * start of the call.
     * @param column What column to put the string at
     * @param row What row to put the string at
     * @param string String to put on the screen
