...
interface Screen : InputProvider, Scrollable, Closeable {
     ...
     * again with `startScreen()` which will restore the screens content to the terminal.
     *
     * @throws IOException if there was an underlying IO error when exiting from private mode
     */
    @Throws(IOException::class)
     ...
     * TextGraphics will be affecting this screen. Remember to call `refresh()` on the screen to see your changes.
     *
     ...
     * @return A `ScreenCharacter` representation of the character in the front-buffer at the specified location
     */
     ...
     * @param column Which column to get the character from
     * @param row Which row to get the character from
     * @return A `ScreenCharacter` representation of the character in the back-buffer at the specified location
     */
     ...
     *
     * Screen implementations of this method do **not** throw IOException.
     */
    ...
    enum class RefreshType {
        ...
        /**
         * In `RefreshType.DELTA` mode, the Screen will calculate a diff between the back-buffer and the
         ...
         * `RefreshType.COMPLETE` instead.
         */
        DELTA,

        /**
         * In `RefreshType.COMPLETE` mode, the screen will send a clear command to the terminal, then redraw the
         * whole back-buffer line by line. This is more expensive than `RefreshType.COMPLETE`, especially when you
