...
public class WindowsConsoleOutputStream extends OutputStream {
	...
	public WindowsConsoleOutputStream(Charset decoder) {
		this(Wincon.Companion.getINSTANCE().GetStdHandle(Wincon.STD_OUTPUT_HANDLE), decoder);
	}
	...
	public synchronized void flush() throws IOException {
		...
		while (!characters.isEmpty()) {
			if (!Wincon.Companion.getINSTANCE().WriteConsole(hConsoleOutput, characters, characters.length(), lpNumberOfCharsWritten, null)) {
